...
function Resume() {
  ...
  return (
    <div className="p-6 border rounded-2xl border-zinc-100 dark:border-zinc-700/40">
      ...
      <Button href="/resume.pdf" variant="secondary" className="w-full mt-6 group">
        Download CV
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Hey there 👋 I’m Bartas.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m a backend engineer with 5+ years of experience developing
            scalable software using Python, Go, and Javascript.
          </p>
          <div className="flex gap-6 mt-6">
            <SocialLink
              href="https://twitter.com/bartasurba"
            ...
            /> */}
            <SocialLink
              href="https://github.com/barturba"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/bartas-urba"
